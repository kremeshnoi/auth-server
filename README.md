...
| `/api/v1/auth/sign-out`   | GET             | accepts **access token** from  <br> **request headers**, to delete that <br> **access** and it's associated **refresh token** from database                        |  `"Access-Token", "your-token"`                                            |
